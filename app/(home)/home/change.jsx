    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-20 mx-4 md:mx-12">
            <div>
                ...
                <div className="bg-[#7a8798] pt-20 pb-8 px-8 text-white" >
                    <div className="h-[240px]">
                        ...
                        <h2 className="text-4xl font-semibold leading-loose">全方位資訊</h2>
                        <p className="leading-relaxed">
                            實時提供各區物業市值資料，分析物業拍賣市場趨勢及定價動態，實現回報最大化
                        </p>
                    </div>
                    <div className="text-center">
                        <Dialog>
                            <DialogTrigger asChild>
                                <Button className="rounded-none bg-white text-black transition-all hover:bg-white hover:opacity-80 mt-16 mx-auto">查看更多</Button>
                            </DialogTrigger>
            ...
            <div>
                ...
                <div className="bg-[#7a8798] pt-20 pb-8 px-8 text-white" >
                    <div className="h-[240px]">
                        <h1 className="text-2xl font-semibold">流程簡化</h1>
                        <h2 className="text-4xl font-semibold leading-loose">自動化交易</h2>
                        <p className="leading-relaxed">
                            通過自動化拍賣流，減少行政負擔，縮短時間並提高交易效率
                        </p>
                    </div>
                    <div className="text-center">
                        <Dialog>
            ...
            <div>
                ...
                <div className="bg-[#7a8798] pt-20 pb-8 px-8 text-white" >
                    <div className="h-[240px]">
                        <h1 className="text-2xl font-semibold">更低成本</h1>
                        <h2 className="text-4xl font-semibold leading-loose">市場半價</h2>
                        <p className="leading-relaxed">
                            最低至0.8%佣金
                        </p>
                    </div>
