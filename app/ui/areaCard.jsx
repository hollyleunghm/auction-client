        ...
        <div className="border border-[#253D59] p-3 mt-4 bg-[#f3f3f3]">
            ...
            <div className="flex gap-4 p-4 border bg-white mt-2">
                <div>
                    ...
                    <p className="mb-1">呎價：@{(property.startingPrice / property.constructionArea).toFixed(2).toLocaleString()} 元</p>
                    <p className="mb-1">實用面積：{property.practicalArea} 平方呎</p>
                    <p className="mb-1">呎價：@{(property.startingPrice / property.practicalArea).toFixed(2).toLocaleString()} 元</p>
                </div>
            </div>
        </div>
    )
